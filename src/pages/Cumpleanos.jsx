...
const CumpleanosPage = () => {
  ...
  const modelosWebsite = [
    { nombre: "Party Time", imagen: null, demoUrl: `/${paisActual}/demo/cumpleanos/party-time` },
    { nombre: "Celebration", imagen: null, demoUrl: `/${paisActual}/demo/cumpleanos/celebration` },
    { nombre: "Birthday Bash", imagen: null, demoUrl: `/${paisActual}/demo/cumpleanos/birthday-bash` },
    { nombre: "Happy Day", imagen: null, demoUrl: `/${paisActual}/demo/cumpleanos/happy-day` }
  ];

  const modelosClassic = [
    { nombre: "Classic Festivo", imagen: null, demoUrl: `/${paisActual}/demo/classic/cumpleanos/festivo` },
    { nombre: "Classic Divertido", imagen: null, demoUrl: `/${paisActual}/demo/classic/cumpleanos/divertido` },
    { nombre: "Classic Moderno", imagen: null, demoUrl: `/${paisActual}/demo/classic/cumpleanos/moderno` },
    { nombre: "Classic Alegre", imagen: null, demoUrl: `/${paisActual}/demo/classic/cumpleanos/alegre` }
  ];
  ...
  return (
    <>
      <SEO
        ...
        canonical="https://eventiadigital.com/modelo/cumpleanos"
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F5F1ED] via-[#FDFBF9] to-[#FFF8F0]">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-2xl sm:text-3xl md:text-4xl text-gray-700 mb-4">
                Invitaciones Digitales de <span className="font-bold text-[#B88B80]">Cumpleaños</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Descubre nuestros diseños divertidos y creativos para todas las edades. Invitaciones únicas que hagan de tu celebración algo memorable.
              </p>
            </div>

            <div className="text-center mb-16">
              <h2 className="text-gray-700 text-lg sm:text-xl mb-6 font-medium">
                Elige el formato de tu invitación de cumpleaños:
              </h2>
                ...
                >
                  <div className="relative h-64 sm:h-80 bg-gray-100 overflow-hidden">
                    {modelo.imagen ? (
                      <img 
                        src={modelo.imagen} 
                        alt={`Invitación de cumpleaños digital ${modelo.nombre} - Diseño divertido y personalizable`}
            ...
            <div className="mt-16 sm:mt-20 max-w-4xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-8">
                ¿Por qué elegir invitaciones digitales para tu cumpleaños?
              </h2>
              <p className="text-gray-600 mb-8 text-base sm:text-lg">
                Las invitaciones digitales de cumpleaños son la opción moderna, divertida y eco-friendly perfecta para tu celebración. 
                Comparte los detalles de forma instantánea por WhatsApp, incluye lista de regalos, 
                confirmación de asistencia RSVP, ubicación GPS y galería de fotos.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Para Todas las Edades</h3>
                  <p className="text-sm text-gray-600">Niños, adultos y más</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Temáticas Variadas</h3>
                  <p className="text-sm text-gray-600">Personajes, deportes, elegante</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Lista de Regalos</h3>
                  <p className="text-sm text-gray-600">Incluye links y sugerencias</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fixed bottom-[35px] sm:bottom-14 md:bottom-4 right-2 sm:right-3 md:right-4 z-50 flex flex-col items-end gap-2">
          ...
          <button
            onClick={() => {
              const mensaje = encodeURIComponent('¡Hola! Me interesa una invitación digital para cumpleaños. ¿Podrían darme más información?');
            ...
            aria-label="Contactar por WhatsApp para cumpleaños"
          >
