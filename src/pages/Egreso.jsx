...
const EgresoPage = () => {
  ...
  const modelosWebsite = [
    { nombre: "Graduate Pride", imagen: null, demoUrl: `/${paisActual}/demo/egreso/graduate-pride` },
    { nombre: "Success Story", imagen: null, demoUrl: `/${paisActual}/demo/egreso/success-story` },
    { nombre: "Achievement", imagen: null, demoUrl: `/${paisActual}/demo/egreso/achievement` },
    { nombre: "New Beginning", imagen: null, demoUrl: `/${paisActual}/demo/egreso/new-beginning` }
  ];

  const modelosClassic = [
    { nombre: "Classic Elegante", imagen: null, demoUrl: `/${paisActual}/demo/classic/egreso/elegante` },
    { nombre: "Classic Profesional", imagen: null, demoUrl: `/${paisActual}/demo/classic/egreso/profesional` },
    { nombre: "Classic Moderno", imagen: null, demoUrl: `/${paisActual}/demo/classic/egreso/moderno` },
    { nombre: "Classic Sobrio", imagen: null, demoUrl: `/${paisActual}/demo/classic/egreso/sobrio` }
  ];
  ...
  return (
    <>
      <SEO
        ...
        canonical="https://eventiadigital.com/modelo/egreso"
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F5F1ED] via-[#FDFBF9] to-[#FFF8F0]">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-2xl sm:text-3xl md:text-4xl text-gray-700 mb-4">
                Invitaciones Digitales de <span className="font-bold text-[#B88B80]">Graduación</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Descubre nuestros diseños elegantes y profesionales para celebrar tu logro académico. Invitaciones únicas que marquen este momento especial.
              </p>
            </div>

            <div className="text-center mb-16">
              <h2 className="text-gray-700 text-lg sm:text-xl mb-6 font-medium">
                Elige el formato de tu invitación de graduación:
              </h2>
                ...
                >
                  <div className="relative h-64 sm:h-80 bg-gray-100 overflow-hidden">
                    {modelo.imagen ? (
                      <img 
                        src={modelo.imagen} 
                        alt={`Invitación de graduación digital ${modelo.nombre} - Diseño elegante y personalizable`}
            ...
            <div className="mt-16 sm:mt-20 max-w-4xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-8">
                ¿Por qué elegir invitaciones digitales para tu graduación?
              </h2>
              <p className="text-gray-600 mb-8 text-base sm:text-lg">
                Las invitaciones digitales de graduación son la opción elegante, profesional y eco-friendly perfecta para celebrar tu logro. 
                Comparte los detalles de la ceremonia y fiesta de forma instantánea por WhatsApp, incluye información del evento, 
                confirmación de asistencia RSVP, ubicación GPS y galería de fotos de tu trayectoria.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Diseños Profesionales</h3>
                  <p className="text-sm text-gray-600">Elegantes y sofisticados</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Todos los Niveles</h3>
                  <p className="text-sm text-gray-600">Bachillerato, universidad, maestría</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Personalizable</h3>
                  <p className="text-sm text-gray-600">Fotos y logros destacados</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fixed bottom-[35px] sm:bottom-14 md:bottom-4 right-2 sm:right-3 md:right-4 z-50 flex flex-col items-end gap-2">
          ...
          <button
            onClick={() => {
              const mensaje = encodeURIComponent('¡Hola! Me interesa una invitación digital para graduación. ¿Podrían darme más información?');
            ...
            aria-label="Contactar por WhatsApp para graduación"
          >
