...
const EmpresarialPage = () => {
  ...
  const modelosWebsite = [
    { nombre: "Corporate Elite", imagen: null, demoUrl: `/${paisActual}/demo/empresarial/corporate-elite` },
    { nombre: "Business Pro", imagen: null, demoUrl: `/${paisActual}/demo/empresarial/business-pro` },
    { nombre: "Executive", imagen: null, demoUrl: `/${paisActual}/demo/empresarial/executive` },
    { nombre: "Professional", imagen: null, demoUrl: `/${paisActual}/demo/empresarial/professional` }
  ];

  const modelosClassic = [
    { nombre: "Classic Corporativo", imagen: null, demoUrl: `/${paisActual}/demo/classic/empresarial/corporativo` },
    { nombre: "Classic Profesional", imagen: null, demoUrl: `/${paisActual}/demo/classic/empresarial/profesional` },
    { nombre: "Classic Moderno", imagen: null, demoUrl: `/${paisActual}/demo/classic/empresarial/moderno` },
    { nombre: "Classic Ejecutivo", imagen: null, demoUrl: `/${paisActual}/demo/classic/empresarial/ejecutivo` }
  ];
  ...
  return (
    <>
      <SEO
        ...
        canonical="https://eventiadigital.com/modelo/empresarial"
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F5F1ED] via-[#FDFBF9] to-[#FFF8F0]">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-2xl sm:text-3xl md:text-4xl text-gray-700 mb-4">
                Invitaciones Digitales <span className="font-bold text-[#B88B80]">Empresariales</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Descubre nuestros diseños profesionales y corporativos para tus eventos empresariales. Invitaciones elegantes que reflejen la imagen de tu empresa.
              </p>
            </div>

            <div className="text-center mb-16">
              <h2 className="text-gray-700 text-lg sm:text-xl mb-6 font-medium">
                Elige el formato de tu invitación empresarial:
              </h2>
                ...
                >
                  <div className="relative h-64 sm:h-80 bg-gray-100 overflow-hidden">
                    {modelo.imagen ? (
                      <img 
                        src={modelo.imagen} 
                        alt={`Invitación empresarial digital ${modelo.nombre} - Diseño profesional y personalizable`}
            ...
            <div className="mt-16 sm:mt-20 max-w-4xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-8">
                ¿Por qué elegir invitaciones digitales para eventos corporativos?
              </h2>
              <p className="text-gray-600 mb-8 text-base sm:text-lg">
                Las invitaciones digitales empresariales son la opción profesional, eficiente y eco-friendly perfecta para eventos corporativos. 
                Gestiona confirmaciones automáticamente, incluye agenda del evento, información de ponentes, 
                RSVP automatizado, ubicación GPS y seguimiento de asistencia en tiempo real.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Diseños Profesionales</h3>
                  <p className="text-sm text-gray-600">Imagen corporativa impecable</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ RSVP Automatizado</h3>
                  <p className="text-sm text-gray-600">Gestión eficiente de confirmaciones</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Seguimiento Real</h3>
                  <p className="text-sm text-gray-600">Control de asistencia en tiempo real</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fixed bottom-[35px] sm:bottom-14 md:bottom-4 right-2 sm:right-3 md:right-4 z-50 flex flex-col items-end gap-2">
          ...
          <button
            onClick={() => {
              const mensaje = encodeURIComponent('¡Hola! Me interesa una invitación digital para un evento corporativo. ¿Podrían darme más información?');
            ...
            aria-label="Contactar por WhatsApp para eventos empresariales"
          >
