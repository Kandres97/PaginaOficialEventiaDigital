...
const BodaPage = () => {
  ...
  const modelosWebsite = [
    { nombre: "Serenity", imagen: "/assets/boda1/mockup.png", demoUrl: `/${paisActual}/demo/boda/boda1` },
    { nombre: "Primicia", imagen: null, demoUrl: `/${paisActual}/demo/boda/primicia` },
    { nombre: "Passport", imagen: null, demoUrl: `/${paisActual}/demo/boda/passport` },
    { nombre: "Paradise", imagen: null, demoUrl: `/${paisActual}/demo/boda/paradise` }
  ];

  const modelosClassic = [
    { nombre: "Classic Elegante", imagen: null, demoUrl: `/${paisActual}/demo/classic/boda/elegante` },
    { nombre: "Classic Romántico", imagen: null, demoUrl: `/${paisActual}/demo/classic/boda/romantico` },
    { nombre: "Classic Moderno", imagen: null, demoUrl: `/${paisActual}/demo/classic/boda/moderno` },
    { nombre: "Classic Floral", imagen: null, demoUrl: `/${paisActual}/demo/classic/boda/floral` }
  ];
  ...
  return (
    <>
      <SEO
        ...
        canonical="https://eventiadigital.com/modelo/boda"
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F5F1ED] via-[#FDFBF9] to-[#FFF8F0]">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-2xl sm:text-3xl md:text-4xl text-gray-700 mb-4">
                Invitaciones Digitales de <span className="font-bold text-[#B88B80]">Boda</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Descubre nuestros diseños elegantes y personalizados para tu gran día. Invitaciones únicas que reflejen el amor y estilo de tu boda.
              </p>
            </div>

            <div className="text-center mb-16">
              <h2 className="text-gray-700 text-lg sm:text-xl mb-6 font-medium">
                Elige el formato de tu invitación de boda:
              </h2>
                ...
                >
                  <div className="relative h-64 sm:h-80 bg-gray-100 overflow-hidden">
                    {modelo.imagen ? (
                      <img 
                        src={modelo.imagen} 
                        alt={`Invitación de boda digital ${modelo.nombre} - Diseño elegante y personalizable`}
            ...
            <div className="mt-16 sm:mt-20 max-w-4xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-8">
                ¿Por qué elegir invitaciones digitales de boda?
              </h2>
              <p className="text-gray-600 mb-8 text-base sm:text-lg">
                Las invitaciones digitales de boda son la opción moderna, elegante y eco-friendly perfecta para tu matrimonio. 
                Comparte los detalles de tu gran día de forma instantánea por WhatsApp, incluye confirmación de asistencia RSVP, 
                ubicación GPS, galería de fotos y música especial.
              </p>
        ...
        <div className="fixed bottom-[35px] sm:bottom-14 md:bottom-4 right-2 sm:right-3 md:right-4 z-50 flex flex-col items-end gap-2">
          ...
          <button
            onClick={() => {
              const mensaje = encodeURIComponent('¡Hola! Me interesa una invitación digital para mi boda. ¿Podrían darme más información?');
            ...
            aria-label="Contactar por WhatsApp para invitaciones de boda"
          >
