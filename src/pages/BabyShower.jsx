...
const BabyShowerPage = () => {
  ...
  const modelosWebsite = [
    { nombre: "Sweet Baby", imagen: null, demoUrl: `/${paisActual}/demo/babyshower/sweet-baby` },
    { nombre: "Little Star", imagen: null, demoUrl: `/${paisActual}/demo/babyshower/little-star` },
    { nombre: "Baby Love", imagen: null, demoUrl: `/${paisActual}/demo/babyshower/baby-love` },
    { nombre: "Tiny Feet", imagen: null, demoUrl: `/${paisActual}/demo/babyshower/tiny-feet` }
  ];

  const modelosClassic = [
    { nombre: "Classic Tierno", imagen: null, demoUrl: `/${paisActual}/demo/classic/babyshower/tierno` },
    { nombre: "Classic Dulce", imagen: null, demoUrl: `/${paisActual}/demo/classic/babyshower/dulce` },
    { nombre: "Classic Moderno", imagen: null, demoUrl: `/${paisActual}/demo/classic/babyshower/moderno` },
    { nombre: "Classic Adorable", imagen: null, demoUrl: `/${paisActual}/demo/classic/babyshower/adorable` }
  ];
  ...
  return (
    <>
      <SEO
        ...
        canonical="https://eventiadigital.com/modelo/baby-shower"
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F5F1ED] via-[#FDFBF9] to-[#FFF8F0]">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-2xl sm:text-3xl md:text-4xl text-gray-700 mb-4">
                Invitaciones Digitales de <span className="font-bold text-[#B88B80]">Baby Shower</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Descubre nuestros diseños tiernos y adorables para celebrar la llegada de tu bebé. Invitaciones únicas llenas de amor.
              </p>
            </div>

            <div className="text-center mb-16">
              <h2 className="text-gray-700 text-lg sm:text-xl mb-6 font-medium">
                Elige el formato de tu invitación de baby shower:
              </h2>
                ...
                >
                  <div className="relative h-64 sm:h-80 bg-gray-100 overflow-hidden">
                    {modelo.imagen ? (
                      <img 
                        src={modelo.imagen} 
                        alt={`Invitación de baby shower digital ${modelo.nombre} - Diseño tierno y personalizable`}
            ...
            <div className="mt-16 sm:mt-20 max-w-4xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-8">
                ¿Por qué elegir invitaciones digitales para tu baby shower?
              </h2>
              <p className="text-gray-600 mb-8 text-base sm:text-lg">
                Las invitaciones digitales para baby shower son la opción moderna, tierna y eco-friendly perfecta para celebrar la llegada de tu bebé. 
                Comparte los detalles de forma instantánea por WhatsApp, incluye lista de regalos, juegos interactivos, 
                confirmación de asistencia RSVP y galería de fotos del embarazo.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Diseños Adorables</h3>
                  <p className="text-sm text-gray-600">Para niño, niña o sorpresa</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Lista de Regalos</h3>
                  <p className="text-sm text-gray-600">Incluye links a tiendas</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Juegos Interactivos</h3>
                  <p className="text-sm text-gray-600">Divierte a tus invitados</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fixed bottom-[35px] sm:bottom-14 md:bottom-4 right-2 sm:right-3 md:right-4 z-50 flex flex-col items-end gap-2">
          ...
          <button
            onClick={() => {
              const mensaje = encodeURIComponent('¡Hola! Me interesa una invitación digital para mi baby shower. ¿Podrían darme más información?');
            ...
            aria-label="Contactar por WhatsApp para baby shower"
          >
