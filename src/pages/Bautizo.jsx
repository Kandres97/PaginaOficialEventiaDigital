...
const BautizoPage = () => {
  ...
  const modelosWebsite = [
    { nombre: "Blessed Dove", imagen: null, demoUrl: `/${paisActual}/demo/bautizo/blessed-dove` },
    { nombre: "Holy Water", imagen: null, demoUrl: `/${paisActual}/demo/bautizo/holy-water` },
    { nombre: "Angel Wings", imagen: null, demoUrl: `/${paisActual}/demo/bautizo/angel-wings` },
    { nombre: "Divine Love", imagen: null, demoUrl: `/${paisActual}/demo/bautizo/divine-love` }
  ];

  const modelosClassic = [
    { nombre: "Classic Tierno", imagen: null, demoUrl: `/${paisActual}/demo/classic/bautizo/tierno` },
    { nombre: "Classic Religioso", imagen: null, demoUrl: `/${paisActual}/demo/classic/bautizo/religioso` },
    { nombre: "Classic Moderno", imagen: null, demoUrl: `/${paisActual}/demo/classic/bautizo/moderno` },
    { nombre: "Classic Espiritual", imagen: null, demoUrl: `/${paisActual}/demo/classic/bautizo/espiritual` }
  ];
  ...
  return (
    <>
      <SEO
        ...
        canonical="https://eventiadigital.com/modelo/bautizo"
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F5F1ED] via-[#FDFBF9] to-[#FFF8F0]">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-2xl sm:text-3xl md:text-4xl text-gray-700 mb-4">
                Invitaciones Digitales de <span className="font-bold text-[#B88B80]">Bautizo</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Descubre nuestros diseños tiernos y religiosos para celebrar este sacramento especial. Invitaciones únicas llenas de bendiciones.
              </p>
            </div>

            <div className="text-center mb-16">
              <h2 className="text-gray-700 text-lg sm:text-xl mb-6 font-medium">
                Elige el formato de tu invitación de bautizo:
              </h2>
                ...
                >
                  <div className="relative h-64 sm:h-80 bg-gray-100 overflow-hidden">
                    {modelo.imagen ? (
                      <img 
                        src={modelo.imagen} 
                        alt={`Invitación de bautizo digital ${modelo.nombre} - Diseño tierno y personalizable`}
            ...
            <div className="mt-16 sm:mt-20 max-w-4xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-8">
                ¿Por qué elegir invitaciones digitales para el bautizo?
              </h2>
              <p className="text-gray-600 mb-8 text-base sm:text-lg">
                Las invitaciones digitales de bautizo son la opción tierna, espiritual y eco-friendly perfecta para este sacramento. 
                Comparte los detalles de la ceremonia y celebración de forma instantánea por WhatsApp, incluye información de la iglesia, padrinos, 
                confirmación de asistencia RSVP, ubicación GPS y galería de fotos del bebé.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Diseños Tiernos</h3>
                  <p className="text-sm text-gray-600">Símbolos religiosos adorables</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Info Completa</h3>
                  <p className="text-sm text-gray-600">Ceremonia, padrinos y celebración</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Galería de Fotos</h3>
                  <p className="text-sm text-gray-600">Comparte fotos del bebé</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fixed bottom-[35px] sm:bottom-14 md:bottom-4 right-2 sm:right-3 md:right-4 z-50 flex flex-col items-end gap-2">
          ...
          <button
            onClick={() => {
              const mensaje = encodeURIComponent('¡Hola! Me interesa una invitación digital para bautizo. ¿Podrían darme más información?');
            ...
            aria-label="Contactar por WhatsApp para bautizo"
          >
