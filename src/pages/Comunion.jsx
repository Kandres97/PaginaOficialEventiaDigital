...
const ComunionPage = () => {
  ...
  const modelosWebsite = [
    { nombre: "Holy Light", imagen: null, demoUrl: `/${paisActual}/demo/comunion/holy-light` },
    { nombre: "Divine Grace", imagen: null, demoUrl: `/${paisActual}/demo/comunion/divine-grace` },
    { nombre: "Sacred Day", imagen: null, demoUrl: `/${paisActual}/demo/comunion/sacred-day` },
    { nombre: "Blessed Moment", imagen: null, demoUrl: `/${paisActual}/demo/comunion/blessed-moment` }
  ];

  const modelosClassic = [
    { nombre: "Classic Elegante", imagen: null, demoUrl: `/${paisActual}/demo/classic/comunion/elegante` },
    { nombre: "Classic Religioso", imagen: null, demoUrl: `/${paisActual}/demo/classic/comunion/religioso` },
    { nombre: "Classic Moderno", imagen: null, demoUrl: `/${paisActual}/demo/classic/comunion/moderno` },
    { nombre: "Classic Espiritual", imagen: null, demoUrl: `/${paisActual}/demo/classic/comunion/espiritual` }
  ];
  ...
  return (
    <>
      <SEO
        ...
        canonical="https://eventiadigital.com/modelo/comunion"
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F5F1ED] via-[#FDFBF9] to-[#FFF8F0]">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-2xl sm:text-3xl md:text-4xl text-gray-700 mb-4">
                Invitaciones Digitales de <span className="font-bold text-[#B88B80]">Primera Comunión</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Descubre nuestros diseños elegantes y religiosos para celebrar este día tan especial. Invitaciones únicas llenas de fe y bendiciones.
              </p>
            </div>

            <div className="text-center mb-16">
              <h2 className="text-gray-700 text-lg sm:text-xl mb-6 font-medium">
                Elige el formato de tu invitación de comunión:
              </h2>
                ...
                >
                  <div className="relative h-64 sm:h-80 bg-gray-100 overflow-hidden">
                    {modelo.imagen ? (
                      <img 
                        src={modelo.imagen} 
                        alt={`Invitación de primera comunión digital ${modelo.nombre} - Diseño elegante y personalizable`}
            ...
            <div className="mt-16 sm:mt-20 max-w-4xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-8">
                ¿Por qué elegir invitaciones digitales para la primera comunión?
              </h2>
              <p className="text-gray-600 mb-8 text-base sm:text-lg">
                Las invitaciones digitales de primera comunión son la opción elegante, espiritual y eco-friendly perfecta para este sacramento. 
                Comparte los detalles de la ceremonia y recepción de forma instantánea por WhatsApp, incluye información de la iglesia, 
                confirmación de asistencia RSVP, ubicación GPS y galería de fotos.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Diseños Religiosos</h3>
                  <p className="text-sm text-gray-600">Símbolos cristianos y elegantes</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Detalles Completos</h3>
                  <p className="text-sm text-gray-600">Ceremonia y recepción</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <h3 className="font-bold text-[#B88B80] mb-2">✓ Personalizable</h3>
                  <p className="text-sm text-gray-600">Fotos y colores a tu gusto</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fixed bottom-[35px] sm:bottom-14 md:bottom-4 right-2 sm:right-3 md:right-4 z-50 flex flex-col items-end gap-2">
          ...
          <button
            onClick={() => {
              const mensaje = encodeURIComponent('¡Hola! Me interesa una invitación digital para primera comunión. ¿Podrían darme más información?');
            ...
            aria-label="Contactar por WhatsApp para comunión"
          >
