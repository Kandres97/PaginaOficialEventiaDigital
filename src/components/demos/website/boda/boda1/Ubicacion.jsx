import outputGif from '../../../../../assets/demos/website/boda/boda1/animations/output-onlinegiftools.gif';
import cheersGif from '../../../../../assets/demos/website/boda/boda1/animations/cheers.gif';
import weddingDress from '../../../../../assets/demos/website/boda/boda1/images/wedding-dress.png';
          ...
          <div className="ubicacion-grid">
            <div className="ubicacion-card">
              <div className="ceremony-icon-container">
                <img src={outputGif} alt="Ceremonia" />
              </div>
      ...
      <div className="dress-code-section">
        <div className="ubicacion-container">
          <div className="dress-code-icon-container">
            ...
            <img src={weddingDress} alt="Código de vestimenta" />
          </div>
