    ...
    <>
      <style>{`
        ...
        .gift-icon-container img {
          ...
          height: 100%;
          object-fit: contain;
          /* Color gris (#6b6b6b) para el regalo */
        ...
        .regalo-gif {
          ...
          height: 50px;
          object-fit: contain;
          /* Filtro para convertir a gris (#6b6b6b) similar al resto del diseño */
          filter: brightness(0) saturate(100%) invert(42%) sepia(0%) saturate(0%) hue-rotate(0deg) brightness(96%) contrast(88%);
          animation: gift-bounce 2s ease-in-out infinite;
        }
        ...
        <div className="regalos-container">
          ...
          <div className="regalos-title">
            ...
            <div className="gift-icon-container">
              <img src="/assets/boda1/gift.gif" alt="Regalo" />
            </div>
          ...
          <div className="regalos-grid">
            ...
            <div className="regalo-card">
              <div className="regalo-icon">
                <img src="/assets/boda1/wallet.gif" alt="Sobre" className="regalo-gif" />
              </div>
            ...
            <div className="regalo-card">
              <div className="regalo-icon">
                <img src="/assets/boda1/money.gif" alt="Transferencia" className="regalo-gif" />
              </div>
